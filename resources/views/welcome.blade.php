...
<head>
    ...
    <title>unBlurred: Information Crystal-Clear</title>
...
<body class="font-open bg-gray-100">
    ...
    {{-- Logo Anchor Open--}}
    <a href="{{ route('home') }}">
    <svg class="w-48 h-auto" viewBox="0 0 533 102" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {{-- Main Menu Bar --}}
    <nav class="navbar-menu px-8 md:px-12 mt-6 md:mt-5">
        <ul class="navbar-parent w-full flex justify-between items-center">
            <div class="left xs:w-3/4">
                <li><i id="menu_bar_icon" class="menu_bar_icon text-2xl md:text-3xl text-gray-800 cursor-pointer ri-menu-4-fill"></i></li>
            </div>
