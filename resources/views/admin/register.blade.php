...
<div class="flex min-h-full flex-col justify-center px-6 py-9 md:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <h1 class="mt-3 text-center text-4xl leading-8 tracking-tight text-gray-900 font-extrabold">Admin Register</h1>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="{{ route('admin.register') }}" method="POST">
        ...
        <div>
          <label for="password" class="block text-base font-medium leading-6 text-black">Password</label>
          <div class="mt-2">
        ...
        <div>
          <input id="submit" type="submit" class="flex w-full justify-center rounded-md bg-red-600 px-3 py-3 font-semibold leading-6 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 text-lg cursor-pointer" value="Admin Register" />
